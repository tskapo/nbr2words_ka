var sityvebad = (function () {
	const zero = "ნული";
	const upTo20 = ["", "ერთი", "ორი", "სამი", "ოთხი", "ხუთი", "ექვსი", "შვიდი", "რვა", "ცხრა", "ათი", "თერთმეტი", "თორმეტი", "ცამეტი", "თოთხმეტი", "თხუთმეტი", "თექვსმეტი", "ჩვიდმეტი", "თვრამეტი", "ცხრამეტი"];
	...
	return {
		getAsWords : getAsWords
	}
})()

Number.prototype.სიტყვად = function () {
	return sityvebad.getAsWords(this)
}
